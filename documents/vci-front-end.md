...
|           | `issueCredentialType` | Specifies the type of credential being issued; this value will be used to query the agent of a certain type of credential; so, it's important to have this type in your [agent's vci metadata configuration](./agent-setup.md#oid4vci_metadata)                                                                                                              |
...
|           | `vpDefinitionId`      | (optional) A specific identifier that fetches the corresponding `presentation_definition` from the [agent](./agent-setup.md#presentation_definitions), dictating how presentations are processed and verified.                                                                                                                                                                       |
