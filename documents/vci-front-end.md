...
|           | `issueCredentialType` | Specifies the type of credential being issued; this value will be used to query the agent of a certain type of credential; so, it's important to have this type in your **agent's vci metadata configuration**                                                                                                                                               |
...
|           | `vpDefinitionId`      | (optional) A specific identifier that fetches the corresponding `presentation_definition` from the agent, dictating how presentations are processed and verified.                                                                                                                                                                                            |
