...
export const DEFAULT_ECOSYSTEM_FROM_SUBDOMAIN_PARTS: number | undefined = process.env.REACT_APP_DEFAULT_ECOSYSTEM_FROM_SUBDOMAIN_PARTS ? parseInt(process.env.REACT_APP_DEFAULT_ECOSYSTEM_FROM_SUBDOMAIN_PARTS, 10) : undefined;
