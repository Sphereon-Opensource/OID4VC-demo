...
const SSIMultiIssuerPage: React.FC = () => {
    ...
    return (
            <div
                    style={{
                        ...
                        height: '100vh',
                        userSelect: 'none',
                        backgroundColor: pageConfig.styles.mainContainer.backgroundColor,
                        alignItems: 'center',
                ...
                <div style={{
                    ...
                    <p className={'inter-normal-48'}
                       style={{color: '#FBFBFB', alignContent: 'center', textAlign: 'center'}}>{t('select_credential_title1') + ' '}
...
export default SSIMultiIssuerPage
